...
import { PieceType, PlayerColor, Theme, Piece, LayoutSettings } from '../types';
...
const PromotionModal: React.FC<PromotionModalProps> = ({ playerColor, onPromote, theme, layoutSettings }) => {
          ...
          {promotionPieces.map((type) => {
            ...
            return (
              <button
                ...
                className={`p-2 sm:p-2.5 w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center ${buttonBgClass} ${buttonHoverBg} rounded-lg transition-all duration-150 ease-in-out transform hover:scale-110 shadow-lg hover:shadow-xl backdrop-blur-md focus:outline-none focus:ring-2 ${focusRingClass}`}
